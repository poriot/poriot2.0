...
namespace eosio { namespace chain {
   ...
   txfee_manager::txfee_manager(){
      init_native_fee(config::system_account_name, N(newaccount), asset(10000));
      ...
      init_native_fee(config::system_account_name, N(updatebp),     asset(500*10000));
      ...
      init_native_fee(config::token_account_name, N(issue),    asset(100000));
      init_native_fee(config::token_account_name, N(create),   asset(500*10000));
