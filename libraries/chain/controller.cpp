...
*/
   ...
   void check_func_open() {
      ...
      if( is_func_open_in_curr_block( self, config::func_typ::use_system01, 3300 ) ) {
      ...
      if( is_func_open_in_curr_block( self, config::func_typ::use_msig, 456 ) ) {
      ...
      if (is_func_has_open(self, config::func_typ::create_eosio_account, 5500)) {
         auto db = memory_db(self);
